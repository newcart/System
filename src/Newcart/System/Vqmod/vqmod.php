...
abstract class Vqmod
{
    ...
    private static function _getMods()
    {
        ...
        self::$_modFileList = glob(__DIR__ . '/xml/*.xml');
        ...
        $xml_folder_time = filemtime(__DIR__ . '/xml');
     ...
     *
     * @return null
     * @description Loops through xml files and attemhandleXMLErrorpts to load them as VqmodObject's
     */
